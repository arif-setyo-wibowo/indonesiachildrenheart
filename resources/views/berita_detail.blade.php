                  ...
                  <article class="post">
                    <div class="post-content mb-5">
                      ...
                      <div class="row g-6 mt-3 mb-10">
                        <div class="col-md-6">
                          <figure class="hover-scale rounded cursor-dark"><a href="{{ asset('assets/')}}/img/photos/b8-full.jpg" data-glightbox="title: Heading; description: Purus Vulputate Sem Tellus Quam" data-gallery="post"> <img src="{{ asset('assets/')}}/img/photos/b8.jpg" alt="" /></a></figure>
                        </div>
                        <!--/column -->
                        <div class="col-md-6">
