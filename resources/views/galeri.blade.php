    ...
    <div class="container pt-10 pt-md-14">
      <div class="row">
        <div class="col-md-8 col-lg-7 col-xl-6 col-xxl-5">
          ...
          <p class="lead fs-lg pe-lg-15 pe-xxl-12">Yayasan Indonesia Children Heart</p>
        </div>
        <!-- /column -->
      </div>
      <!-- /.row -->
      ...
      <div class="grid grid-view projects-masonry">
        ...
        <div class="row gx-md-8 gy-10 gy-md-13 isotope">
          <div class="project item col-md-6 col-xl-4 product">
            ...
            <div class="project-details d-flex justify-content-center flex-column">
              <div class="post-header">
                <div class="post-category text-line mb-2 text-purple">Cosmetic</div>
          ...
          <div class="project item col-md-6 col-xl-4 workshop">
            ...
            <div class="project-details d-flex justify-content-center flex-column">
              <div class="post-header">
                <div class="post-category text-line mb-2 text-leaf">Coffee</div>
          ...
          <div class="project item col-md-6 col-xl-4 still-life">
            ...
            <div class="project-details d-flex justify-content-center flex-column">
              <div class="post-header">
                <div class="post-category text-line mb-2 text-violet">Still Life</div>
          ...
          <div class="project item col-md-6 col-xl-4 workshop">
            ...
            <div class="project-details d-flex justify-content-center flex-column">
              <div class="post-header">
                <div class="post-category text-line mb-2 text-green">Workshop</div>
          ...
          <div class="project item col-md-6 col-xl-4 concept">
            <figure class="lift rounded mb-6"><a href="./single-project2.html"> <img src="./assets/img/photos/cs22.jpg" alt="" /></a></figure>
            <div class="project-details d-flex justify-content-center flex-column">
              <div class="post-header">
                <div class="post-category text-line mb-2 text-red">Concept</div>
          ...
          <div class="project item col-md-6 col-xl-4 concept still-life">
            <figure class="lift rounded mb-6"><a href="./single-project.html"> <img src="./assets/img/photos/cs23.jpg" alt="" /></a></figure>
            <div class="project-details d-flex justify-content-center flex-column">
              <div class="post-header">
                <div class="post-category text-line mb-2 text-aqua">Concept</div>
          ...
          <!-- /.project -->
          <div class="project item col-md-6 col-xl-4 product">
            <figure class="lift rounded mb-6"><a href="./single-project3.html"> <img src="./assets/img/photos/cs24.jpg" alt="" /></a></figure>
            <div class="project-details d-flex justify-content-center flex-column">
              <div class="post-header">
