      ...
      <div class="row grid-view gx-md-8 gx-xl-10 gy-8 gy-lg-0">
        <div class="col-md-6 col-lg-3">
          <div class="position-relative">
            ...
            <div class="card">
              <figure class="card-img-top"><img class="img-fluid" src="{{ asset('assets/')}}/img/avatars/t1.jpg" srcset="{{ asset('assets/')}}/img/avatars/t1@2x.jpg 2x" alt="" /></figure>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="position-relative">
            ...
            <div class="card">
              <figure class="card-img-top"><img class="img-fluid" src="{{ asset('assets/')}}/img/avatars/t2.jpg" srcset="{{ asset('assets/')}}/img/avatars/t2@2x.jpg 2x" alt="" /></figure>
              <div class="card-body px-6 py-5">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="position-relative">
            ...
            <div class="card">
              <figure class="card-img-top"><img class="img-fluid" src="{{ asset('assets/')}}/img/avatars/t3.jpg" srcset="{{ asset('assets/')}}/img/avatars/t3@2x.jpg 2x" alt="" /></figure>
              <div class="card-body px-6 py-5">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="position-relative">
            ...
            <div class="card">
              <figure class="card-img-top"><img class="img-fluid" src="{{ asset('assets/')}}/img/avatars/t4.jpg" srcset="{{ asset('assets/')}}/img/avatars/t4@2x.jpg 2x" alt="" /></figure>
              <div class="card-body px-6 py-5">
