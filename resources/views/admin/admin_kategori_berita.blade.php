                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-three-tabContent">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-info btn-sm"
                                                                onclick="editKategori('{{ $data->idkategori }}','{{ $data->kategori }}')">
                                                                <i class="fas fa-pencil-alt"></i>
                                                                Edit
                                                            </button>
                                                            <a class="btn btn-danger btn-sm delete-btn-relasi"
                                                                data-url="{{ route('admin.delete.kategori', ['id' => $data->idkategori]) }}">
                                    ...
                                    <div class="tab-pane fade" id="tab-tambah-edit" role="tabpanel"
                                        ...
                                        <form action="{{ route('admin.kategori.store.update') }}" method="POST">
                                            @csrf
